...
class CfnDatabase(
    ...
    class DatabaseInputProperty:
        def __init__(
            self,
            *,
            create_table_default_permissions: typing.Optional[typing.Union[aws_cdk.core.IResolvable, typing.List[typing.Union[aws_cdk.core.IResolvable, "CfnDatabase.PrincipalPrivilegesProperty"]]]] = None,
            description: typing.Optional[builtins.str] = None,
